...
for (const htmlFile of ["registration/index.html", "registration/dashboard.html", "registration/payment-return.html", "registration/declaration.html", "registration/manage.html"]) {
...
for (const required of ["Stage 1 of 4", "Add runner to order", "Add another runner", "View organiser test area", "Start a test registration", "Continue to payment"])
  if (!runnerPage.includes(required)) errors.push(`Runner journey is missing: ${required}`);
if (runnerPage.includes("View payment status")) errors.push("Runner journey still shows View payment status before payment");
...
for (const id of ["close-detail", "reset-test", "export-csv", "keep-entry", "confirm-cancel-entry", "close-race-number", "race-number-form", "close-entry-correction", "entry-correction-form"])
